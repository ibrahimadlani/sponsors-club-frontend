  ...
  return (
    <SidebarMenu className="flex justify-end flex-row items-center gap-3 d-none">
      {/* Call to Action link */}
        ...
        >
          <div className="rounded-full hover:bg-muted/70 dark:hover:bg-muted/90 transition-colors h-10  px-3 xl:flex justify-center items-center font-medium hidden">
