...
export default function PageHeader({ user, rightSlot = null, className = "" }) {
  return (
    <header className={cn("sticky top-0 z-50 w-full bg-background text-center border-b px-6 md:px-0", className)}>
      <div className="relative flex items-center justify-center min-h-[80px]">
        ...
        <div className="relative hidden lg:flex lg:max-w-md lg:flex-col lg:items-center lg:justify-center">
          <NavMenu />
        </div>
